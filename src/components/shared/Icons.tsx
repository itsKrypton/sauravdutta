...
const defaultStroke: IconProps & React.SVGProps<SVGSVGElement> = {
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  strokeWidth: 2,
...
export function SunIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg className={className} {...defaultStroke}>
...
export function VolumeMuteIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg className={className} {...defaultStroke}>
...
export function VolumeUpIcon({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg className={className} {...defaultStroke}>
      <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" />
