  ...
  return (
    <AnimatedSection>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="rounded-3xl bg-gradient-to-br from-bg-secondary via-bg-secondary to-accent/5 border border-border/50 px-6 py-16 text-center sm:px-12">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center rounded-lg bg-accent px-6 py-3 text-sm font-medium text-white transition-all duration-fast hover:opacity-90 hover:shadow-[--accent-glow]"
            >
